...
![image-20190731162426233](http://blogpicturekoko.oss-cn-beijing.aliyuncs.com/blog/2020-02-29-052549.jpg)

如上图所示：结构上，从左到右，可以分成三层：输入层（Input layer），隐藏层（Hidden layer）和输出层（Output layer）。输入层和输出层，对应着训练样本的输入和输出。隐藏层是抽象的非线性的中间层。

## 计算过程

![image-20190731162615514](http://blogpicturekoko.oss-cn-beijing.aliyuncs.com/blog/2020-02-29-052551.jpg)
...
![image-20190731174048703](http://blogpicturekoko.oss-cn-beijing.aliyuncs.com/blog/2020-02-29-52554.jpg)

![image-20190731174004216](http://blogpicturekoko.oss-cn-beijing.aliyuncs.com/blog/2020-02-29-052553.jpg)
...
![image-20190731173529624](http://blogpicturekoko.oss-cn-beijing.aliyuncs.com/blog/2020-02-29-052554.jpg)
